...
public class HTTPUtils {
	...
	public HTTPUtils() {
		...
		try {
			...
			FileInputStream fis = new FileInputStream(clientProp.getProperty("cert.file.path", "/config/cert/ca.p12"));
	...
	public String postHTTPRequest(String url, String requestMethod, String contentType, String msgParam) throws CommunicationException {
		...
		try {
			...
			if (authorization != null) {
	            ...
	            log.info("base64Authorization: " + base64Authorization);
